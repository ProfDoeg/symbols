# The Path of Aleph: research brief
...
ELEMENT. The Path of Aleph: path 11 of the 32 on Kircher's tree, the letter Aleph (ox, value 1, a mother letter), joining Kether-Chokmah; Golden Dawn attribution Air, tarot trump the Fool; the Yetziratic 'Scintillating Intelligence'. Give at the top the Hebrew name, the number or letter, the position on
...
THREADS TO PULL, each to be verified against the sources and dated: the letter's form and history from proto-Sinaitic to the square script; its status as mother letter in the Sefer Yetzirah with the attribution (Air) and the variants between the Saadia, Gra and Ari recensions; the Yetziratic text of path 11 in Westcott's translation with the Hebrew; what the letter joins on the Ari and Gra trees versus Kircher's; the trump the Fool and the Golden Dawn's reasoning (and Crowley's where he differs); the four colour scales; the Nightside tunnel of this path in Grant's Nightside of Eden with its demon; the letter's Talmudic and Zoharic lore (the Otiyot de-Rabbi Akiva, the letters petitioning to begin the Torah); the tribe and month if a simple letter, the planet and the pair of opposites if a double, the element if a mother; the letter in gematria and in the divine names; pathworking accounts.
