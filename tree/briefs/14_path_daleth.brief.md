# The Path of Daleth: research brief
...
ELEMENT. The Path of Daleth: path 14 of the 32 on Kircher's tree, the letter Daleth (door, value 4, a double letter), joining Chokmah-Binah; Golden Dawn attribution Venus, tarot trump the Empress; the Yetziratic 'Illuminating Intelligence'. Give at the top the Hebrew name, the number or letter, the position on
...
THREADS TO PULL, each to be verified against the sources and dated: the letter's form and history from proto-Sinaitic to the square script; its status as double letter in the Sefer Yetzirah with the attribution (Venus) and the variants between the Saadia, Gra and Ari recensions; the Yetziratic text of path 14 in Westcott's translation with the Hebrew; what the letter joins on the Ari and Gra trees versus Kircher's; the trump the Empress and the Golden Dawn's reasoning (and Crowley's where he differs); the four colour scales; the Nightside tunnel of this path in Grant's Nightside of Eden with its demon; the letter's Talmudic and Zoharic lore (the Otiyot de-Rabbi Akiva, the letters petitioning to begin the Torah); the tribe and month if a simple letter, the planet and the pair of opposites if a double, the element if a mother; the letter in gematria and in the divine names; pathworking accounts.
